...
public class  DbWrapper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 2) {
            db.execSQL("ALTER TABLE " + SessionEntry.TABLE_NAME + " ADD COLUMN " + SessionEntry.COLUMN_NAME_START_LATITUDE + TYPE_REAL + ";");
            db.execSQL("ALTER TABLE " + SessionEntry.TABLE_NAME + " ADD COLUMN " + SessionEntry.COLUMN_NAME_START_LONGITUDE + TYPE_REAL + ";");
            db.execSQL("ALTER TABLE " + SessionEntry.TABLE_NAME + " ADD COLUMN " + SessionEntry.COLUMN_NAME_END_LATITUDE + TYPE_REAL + ";");
            db.execSQL("ALTER TABLE " + SessionEntry.TABLE_NAME + " ADD COLUMN " + SessionEntry.COLUMN_NAME_END_LONGITUDE + TYPE_REAL + ";");
        }
    }
